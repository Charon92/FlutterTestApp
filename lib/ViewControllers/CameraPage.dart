...
import '../Components/CameraPhoto.dart';
...
class _CameraPageState extends State<CameraPage>
  ...
  Widget _thumbnailWidget() {
    final FijkPlayer localVideoController = player;
          ...
          children: <Widget>[
            ...
            ...(!kIsWeb
              ...
              IconButton(
                ...
                : []),
            IconButton(
              icon: Icon(enableAudio ? Icons.volume_up : Icons.volume_mute, color: Colors.white),
              color: Colors.blue,
  ...
  Widget _captureControlRowWidget() {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
          icon: const Icon(Icons.pause_presentation, color: Colors.white),
          color:
      ...
      if ( videoFile != null ) {
        setState(() {
          player.setDataSource(
              videoFile!.path, autoPlay: false, showCover: true);
        });
      }
    }
    await player.start();
